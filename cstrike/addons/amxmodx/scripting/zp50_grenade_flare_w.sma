...
new g_model_w_grenade_flare[MODEL_MAX_LENGTH] = "models/w_smokegrenade.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Grenade: Flare", ZP_VERSION_STRING, "Leo_[BH] & ZP Dev Team")
...
public plugin_precache()
{
	...
	if (!amx_load_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FLARE", g_model_w_grenade_flare, charsmax(g_model_w_grenade_flare)))
		amx_save_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FLARE", g_model_w_grenade_flare)
	...
	precache_model(g_model_w_grenade_flare)
...
public fw_SetModel(entity, const model[])
{
	...
	if (model[9] == 's' && model[10] == 'm')
	{
		...
		// Set grenade W-Model
		engfunc( EngFunc_SetModel, entity, g_model_w_grenade_flare)
