...
// Patched by Leo_[BH] and add WORLD MODEL Support
...
new g_model_w_grenade_infect[MODEL_MAX_LENGTH] = "models/w_hegrenade.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Item: Infection Bomb", ZP_VERSION_STRING, "Leo_[BH] & ZP Dev Team")
...
public plugin_precache()
{
	...
	if (!amx_load_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE INFECT", g_model_w_grenade_infect, charsmax(g_model_w_grenade_infect)))
		amx_save_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE INFECT", g_model_w_grenade_infect)
	...
	precache_model(g_model_w_grenade_infect)
...
public fw_SetModel(entity, const model[])
{
	...
	if (model[9] == 'h' && model[10] == 'e')
	{
		...
		// Set grenade W-Model
		engfunc( EngFunc_SetModel, entity, g_model_w_grenade_infect)
