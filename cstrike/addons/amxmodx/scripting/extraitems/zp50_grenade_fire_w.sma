...
new g_model_w_grenade_fire[MODEL_MAX_LENGTH] = "models/w_hegrenade.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Grenade: Fire", ZP_VERSION_STRING, "Leo_[BH] & ZP Dev Team")
...
public plugin_precache()
{
	...
	if (!amx_load_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FIRE", g_model_w_grenade_fire, charsmax(g_model_w_grenade_fire)))
		amx_save_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FIRE", g_model_w_grenade_fire)	
	...
	precache_model(g_model_w_grenade_fire)
...
public fw_SetModel(entity, const model[])
{
	...
	if (model[9] == 'h' && model[10] == 'e')
	{
		...
		// Set grenade W-Model
		engfunc( EngFunc_SetModel, entity, g_model_w_grenade_fire)
