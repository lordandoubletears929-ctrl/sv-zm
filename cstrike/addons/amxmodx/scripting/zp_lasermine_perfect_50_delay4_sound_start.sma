...
#define LM_BUY_LIMIT_PER_ROUND 999 // Shop manager controls real round limits
#define LM_COST_FIRST_BUY 0 // Shop manager controls real cost
#define LM_COST_SECOND_BUY 0 // Shop manager controls real cost
...
{
	if(g_itemid == itemid) {
		// Cost and round limits are controlled by zp50_custom_hub_cfg_shop.
		g_lm_ammo[id]++
