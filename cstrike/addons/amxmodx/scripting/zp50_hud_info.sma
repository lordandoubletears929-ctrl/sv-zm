...
public ShowHUD(taskid)
{
	...
	if (player != ID_SHOWHUD)
	{
		...
		set_hudmessage(HUD_STATS_SPEC_R, HUD_STATS_SPEC_G, HUD_STATS_SPEC_B, HUD_SPECT_X, HUD_SPECT_Y, 0, 6.0, 2.0, 2.0, 2.0, -1)
	...
	{
		// Show health, class
		set_hudmessage(red, green, blue, HUD_STATS_X, HUD_STATS_Y, 0, 6.0, 2.0, 2.0, 2.0, -1)
