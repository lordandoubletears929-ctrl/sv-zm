...
new g_model_w_grenade_frost[MODEL_MAX_LENGTH] = "models/w_flashbang.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Grenade: Frost", ZP_VERSION_STRING, "Leo_[BH] & ZP Dev Team")
...
public plugin_precache()
{
	...
	if (!amx_load_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FROST", g_model_w_grenade_frost, charsmax(g_model_w_grenade_frost)))
		amx_save_setting_string(ZP_SETTINGS_FILE, "Weapon Models", "WORLD GRENADE FROST", g_model_w_grenade_frost)
	...
	precache_model(g_model_w_grenade_frost)
...
public fw_SetModel(entity, const model[])
{
	...
	if (model[9] == 'f' && model[10] == 'l')
	{
		...
		// Set grenade W-Model
		engfunc( EngFunc_SetModel, entity, g_model_w_grenade_frost)
